sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/wedonate/ssc/eng/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#HelloWorld-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#HelloWorld-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.wedonate.ssc.eng.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/wedonate/ssc/eng/localService/mockserver"], function (mockserver) {
